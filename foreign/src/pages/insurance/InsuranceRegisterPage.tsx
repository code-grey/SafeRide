        ...
        <div className="min-h-screen bg-dark-background text-white flex items-center justify-center relative overflow-hidden py-12">
            ...
            <div className="relative z-10 w-full max-w-md px-6">
                ...
                <div className="text-center mb-12">
                    ...
                    <p className="text-accent-blue font-mono text-xs tracking-[0.2em] uppercase">Insurance Registration</p>
                </div>
                ...
                <div className="bg-dark-surface/50 backdrop-blur-xl border border-white/10 p-8 relative overflow-hidden">
                    ...
                    <h2 className="text-2xl font-light tracking-tight mb-8 text-center">Register Company</h2>

                    <form className="space-y-6">
                        {/* Company Name Field */}
                        <div>
                            <label htmlFor="companyName" className="block text-gray-400 text-sm font-mono uppercase tracking-wider mb-2">
                                Company Name
                            </label>
                            <input
                                type="text"
                        ...
                        <div>
                            <label htmlFor="license" className="block text-gray-400 text-sm font-mono uppercase tracking-wider mb-2">
                                License Number
                            </label>
                            <input
                                type="text"
                    ...
                    <div className="mt-8 text-center text-sm">
                        <div className="pt-4 border-t border-white/10">
                            ...
                            <Link to="/insurance-portal/login" className="text-accent-blue hover:text-white transition-colors font-medium">
                                Sign In
                            </Link>
                        </div>
                    </div>
